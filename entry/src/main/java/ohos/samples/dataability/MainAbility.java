...
public class MainAbility extends Ability {
    ...
    public void onStart(Intent intent) {
        HiLog.info(LABEL_LOG, "------------in MainAbility onStart!");
...
//        try{
//        ContextRegistry.register(this.getApplicationContext());
//        RdbOpenCallbackRegistry.register(new MyRdbOpenCallback());
//        } catch (Exception exception) {
//            HiLog.error(LABEL_LOG, "------------注册到Bee时失败!");
//        }
    }
